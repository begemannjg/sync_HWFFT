...
%feature("docstring") gr::sync_fft::hwfft "<+description of block+>"

%feature("docstring") gr::sync_fft::hwfft::make "Return a shared_ptr to a new instance of sync_fft::hwfft.
